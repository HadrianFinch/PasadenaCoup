...
vm = {
    ...
    globalChatMessages: ko.observableArray(['Welcome to Coup Online']), // The global chat messages that have been received.
...
function roleDescription(role) {
    ...
    if (role === 'contessa') {
        return 'Gives two coins to another player; Block assassination';
    }
    if (role === 'duke') {
